...
-- # Description
-- Please write a SQL statement to query the information of all courses whose teacher ID is 4 and the number of students is more than 500（excluding 500) in the course table courses .
...
-- id	name	student_count	created_at	teacher_id
-- 1	Advanced Algorithms	180	2020-6-1	4
-- 2	System Design	1350	2020-7-18	3
