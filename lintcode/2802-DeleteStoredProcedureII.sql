...
-- # Description
-- Now you need to delete a stored procedure getTeachers_2() from the current database, please write SQL to implement it.
...
-- 'getTeachers'	'PROCEDURE'	'DEFINER'	'utf8mb4'	'utf8mb4_general_ci'	'utf8mb4_bin'
