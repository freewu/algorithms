...
-- # Description
-- Please write a SQL statement to select the information of all courses which named 'System Design' or 'Django' and the number of students student_count is more than 1000 from the courses table.
...
-- Data is guaranteed：the course 'System Design' or 'Django' is exist
-- Example
-- Example 1:
...
-- id	name	student_count	created_at	teacher_id
-- 1	Advanced Algorithms	880	2020-6-1	4
-- 2	System Design	350	2020-7-18	3
-- 3	Django	780	2020-2-29	3
-- 4	Web	340	2020-4-22	4
-- 5	Big Data	700	2020-9-11	1
-- 6	Artificial Intelligence	1660	2018-5-13	3
...
FROM
	courses
WHERE
	student_count > 1000 AND
	name IN ('System Design','Django')