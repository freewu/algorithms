...
func main() {
    ...
    fmt.Println(findGCD([]int{1,2,3,4,5,6,7,8,9})) // 1
    fmt.Println(findGCD([]int{9,8,7,6,5,4,3,2,1})) // 1

    fmt.Println(findGCD1([]int{2,5,6,9,10})) // 2
    fmt.Println(findGCD1([]int{7,5,6,8,3})) // 1
    fmt.Println(findGCD1([]int{3,3})) // 3
    fmt.Println(findGCD1([]int{1,2,3,4,5,6,7,8,9})) // 1
    fmt.Println(findGCD1([]int{9,8,7,6,5,4,3,2,1})) // 1

    fmt.Println(findGCD2([]int{2,5,6,9,10})) // 2
    fmt.Println(findGCD2([]int{7,5,6,8,3})) // 1
    fmt.Println(findGCD2([]int{3,3})) // 3
    fmt.Println(findGCD2([]int{1,2,3,4,5,6,7,8,9})) // 1
    fmt.Println(findGCD2([]int{9,8,7,6,5,4,3,2,1})) // 1

    fmt.Println(findGCD3([]int{2,5,6,9,10})) // 2
    fmt.Println(findGCD3([]int{7,5,6,8,3})) // 1
    fmt.Println(findGCD3([]int{3,3})) // 3
    fmt.Println(findGCD3([]int{1,2,3,4,5,6,7,8,9})) // 1
    fmt.Println(findGCD3([]int{9,8,7,6,5,4,3,2,1})) // 1

    fmt.Println(findGCD4([]int{2,5,6,9,10})) // 2
    fmt.Println(findGCD4([]int{7,5,6,8,3})) // 1
    fmt.Println(findGCD4([]int{3,3})) // 3
    fmt.Println(findGCD4([]int{1,2,3,4,5,6,7,8,9})) // 1
    fmt.Println(findGCD4([]int{9,8,7,6,5,4,3,2,1})) // 1

    fmt.Println(findGCD5([]int{2,5,6,9,10})) // 2
    fmt.Println(findGCD5([]int{7,5,6,8,3})) // 1
    fmt.Println(findGCD5([]int{3,3})) // 3
    fmt.Println(findGCD5([]int{1,2,3,4,5,6,7,8,9})) // 1
    fmt.Println(findGCD5([]int{9,8,7,6,5,4,3,2,1})) // 1
}