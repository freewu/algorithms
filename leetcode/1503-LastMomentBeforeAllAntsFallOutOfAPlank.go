...
// Example 3:
// <img src="https://assets.leetcode.com/uploads/2020/06/17/ants3.jpg" />
...
func main() {
    ...
    // -The ant at index 4 is named D and going to the left.
    // The last moment when an ant was on the plank is t = 4 seconds. After that, it falls immediately out of the plank. (i.e., We can say that at t = 4.0000000001, there are no ants on the plank).
    fmt.Println(getLastMoment(4, []int{4,3}, []int{0,1})) // 4
    // Example 2:
    // <img src="https://assets.leetcode.com/uploads/2020/06/17/ants2.jpg" />
    // Input: n = 7, left = [], right = [0,1,2,3,4,5,6,7]
    // Output: 7
    // Explanation: All ants are going to the right, the ant at index 0 needs 7 seconds to fall.
    fmt.Println(getLastMoment(7, []int{}, []int{0,1,2,3,4,5,6,7})) // 7
    // Example 3:
    // <img src="https://assets.leetcode.com/uploads/2020/06/17/ants3.jpg" />
    // Input: n = 7, left = [0,1,2,3,4,5,6,7], right = []
    // Output: 7
    // Explanation: All ants are going to the left, the ant at index 7 needs 7 seconds to fall.
    fmt.Println(getLastMoment(7, []int{0,1,2,3,4,5,6,7}, []int{})) // 7
}