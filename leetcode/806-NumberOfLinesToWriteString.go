...
func numberOfLines(widths []int, s string) []int {
    ...
    for _, c := range s {
        i := c - 'a'
        if count + widths[i] <= 100 { // 还未超过 100 单位
            count += widths[i] 
        }else {
            lineCount++ // 超过了 100 个单位 换行
            count = widths[i]
        }
    }
...
func main() {
    ...
    // uvwxyz      // 60 pixels wide
    // There are a total of 3 lines, and the last line is 60 pixels wide.
    fmt.Println(numberOfLines([]int{10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10}, "abcdefghijklmnopqrstuvwxyz")) // [3,60]
    // Example 2:
    // Input: widths = [4,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10], s = "bbbcccdddaaa"
    // Output: [2,4]
    // Explanation: You can write s as follows:
    ...
    // a            // 4 pixels wide
    // There are a total of 2 lines, and the last line is 4 pixels wide.
    fmt.Println(numberOfLines([]int{4,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10}, "bbbcccdddaaa")) // [2,4]
}