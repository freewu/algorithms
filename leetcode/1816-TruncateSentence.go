...
func main() {
    ...
    fmt.Println(truncateSentence1("Hello how are you Contestant", 4)) // "Hello how are you"
    fmt.Println(truncateSentence1("What is the solution to this problem", 4)) // "What is the solution"
    fmt.Println(truncateSentence1("chopper is not a tanuki", 5)) // "chopper is not a tanuki"
}