...
func findPeakElement2(nums []int) int {
    var find func(n []int, i, j int) int
    find = func(n []int, i, j int) int {
        mid := (i + j) / 2
...
func main() {
    ...
    fmt.Printf("findPeakElement2([]int{ 1,2,3,1 }) = %v\n",findPeakElement2([]int{ 1,2,3,1 })) // 2
    fmt.Printf("findPeakElement2([]int{ 1,2,1,3,5,6,4 }) = %v\n",findPeakElement2([]int{ 1,2,1,3,5,6,4 })) // 5
}