...
func peopleAwareOfSecret(n int, delay int, forget int) int {
    dp, num, mod := make([]int, n), 0, 1_000_000_007
    dp[0] = 1
    for i := 1; i < n; i++ {
        if i >= delay {
            num += dp[i - delay]
...
func main() {
    ...
    fmt.Println(peopleAwareOfSecret(2, 1, 2)) // 2
    fmt.Println(peopleAwareOfSecret(1000, 1, 1000)) // 344211605
    fmt.Println(peopleAwareOfSecret(1000, 999, 1000)) // 2
}