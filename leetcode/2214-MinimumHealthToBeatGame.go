...
func minimumHealth(damage []int, armor int) int64 {
    ...
    if mx < armor {
        return int64(sum - mx + 1)
    }
    return int64(sum - armor + 1)
}
...
func main() {
    ...
    // On round 4, take 3 damage. You have 4 - 3 = 1 health.
    // Note that 13 is the minimum health you need to start with to beat the game.
    fmt.Println(minimumHealth([]int{2,7,4,3}, 4)) // 13
    // Example 2:
    // Input: damage = [2,5,3,4], armor = 7
    // Output: 10
    // Explanation: One optimal way to beat the game starting at 10 health is:
    ...
    // On round 4, take 4 damage. You have 5 - 4 = 1 health.
    // Note that 10 is the minimum health you need to start with to beat the game.
    fmt.Println(minimumHealth([]int{2,5,3,4}, 7)) // 10
    // Example 3:
    // Input: damage = [3,3,3], armor = 0
    // Output: 10
    // Explanation: One optimal way to beat the game starting at 10 health is:
    ...
    // On round 3, take 3 damage. You have 4 - 3 = 1 health.
    // Note that you did not use your armor ability.
    fmt.Println(minimumHealth([]int{3,3,3}, 0)) // 10
}