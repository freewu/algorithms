...
func main() {
    ...
    fmt.Println(isPowerOfTwo(2 << 30)) // false
    ...
    fmt.Println(isPowerOfTwo1(0)) // false
    fmt.Println(isPowerOfTwo1(2 << 30)) // true
    ...
    fmt.Println(isPowerOfTwo2(0)) // false
    fmt.Println(isPowerOfTwo2(2 << 30)) // true
    ...
    fmt.Println(isPowerOfTwo3(0)) // false
    fmt.Println(isPowerOfTwo3(2 << 30)) // true
}