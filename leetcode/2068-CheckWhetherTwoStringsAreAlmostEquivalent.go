...
func main() {
    ...
    fmt.Println(checkAlmostEquivalent1("aaaa", "bccb")) // false
    fmt.Println(checkAlmostEquivalent1("abcdeef", "abaaacc")) // true
    fmt.Println(checkAlmostEquivalent1("cccddabba", "babababab")) // true
}