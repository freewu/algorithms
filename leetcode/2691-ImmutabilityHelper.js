...
ImmutableHelper.prototype.produce = function(mutator) {
    var res = {};
    mutator(createProxy(this.obj, res));
    return res;
};

var createProxy = function(obj,res) {
    return new Proxy(obj, {
        get(x, prop) {
            if (typeof obj[prop] === 'object' && obj[prop] !== null) {
                res[prop] = res[prop]? res[prop] : {};
                return createProxy(obj[prop], res[prop]);
            }
            return res[prop]?  res[prop] : x[prop];
        },
        set(x, prop, value) {
            res[prop] = value;
        }
