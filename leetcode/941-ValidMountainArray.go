...
func main() {
    ...
    fmt.Println(validMountainArray([]int{1,2,3,4,5,6,7,8,9})) // false
    fmt.Println(validMountainArray([]int{9,8,7,6,5,4,3,2,1})) // false
    ...
    fmt.Println(validMountainArray1([]int{1,2,3,4,5,6,7,8,9})) // false
    fmt.Println(validMountainArray1([]int{9,8,7,6,5,4,3,2,1})) // false
}