...
func maxLength(arr []string) int {
    ...
    var dfs func (c []uint32, index int, mask uint32, res *int)
    dfs = func (c []uint32, index int, mask uint32, res *int) {
...
func main() {
    ...
    fmt.Println(maxLength([]string{"bluefrog", "leetcode", "freewu"})) // 8
    ...
    fmt.Println(maxLength1([]string{"bluefrog", "leetcode", "freewu"})) // 8
}