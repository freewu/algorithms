...
func constructFromPrePost(preorder []int, postorder []int) *TreeNode {
	...
	return build(preorder, 0, l - 1, postorder, 0, l - 1)
}

func build(preorder []int,  pres int,  pree int, postorder []int,  posts int,  poste int) *TreeNode {
	if pres > pree {
		return nil
	}
	if pres == pree {
