...
func main() {
    ...
    // Input: n = 6, meetings = [[1,2,5],[2,3,8],[1,5,10]], firstPerson = 1
    // Output: [0,1,2,3,5]
    fmt.Println(findAllPeople(
        6, // n
        [][]int{[]int{1,2,5},[]int{2,3,8},[]int{1,5,10}}, // meetings
        1, // firstPerson
    )) // [0,1,2,3,5]
    // Explanation:
    // At time 0, person 0 shares the secret with person 1.
    ...
    fmt.Println(findAllPeople(
        4, // n
        [][]int{[]int{3,1,3},[]int{1,2,2},[]int{0,3,3}}, // meetings
        3, // firstPerson
    )) // [0,1,3]
    // Explanation:
    // At time 0, person 0 shares the secret with person 3.
    ...
    fmt.Println(findAllPeople(
        5, // n
        [][]int{[]int{3,4,2},[]int{1,2,1},[]int{2,3,1}}, // meetings
        1, // firstPerson
    )) // [0,1,2,3,4]
    // Explanation:
    // At time 0, person 0 shares the secret with person 1.
