...
// best solution
func searchBest(nums []int, target int) bool {
...
func main() {
	...
	fmt.Printf("searchBest([]int{2,5,6,0,0,1,2},0) = %v\n",searchBest([]int{2,5,6,0,0,1,2},0)) // true
	fmt.Printf("searchBest([]int{2,5,6,0,0,1,2},3) = %v\n",searchBest([]int{2,5,6,0,0,1,2},3)) // false
}
