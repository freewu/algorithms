...
func main() {
    ...
    fmt.Println(ipToCIDR("192.168.1.1", 8)) // [192.168.1.1/32 192.168.1.2/31 192.168.1.4/30 192.168.1.8/32]
    fmt.Println(ipToCIDR("114.114.114.114", 8)) // [114.114.114.114/31 114.114.114.116/30 114.114.114.120/31]
}