...
func sortArray1(nums []int, pre []int) int {
    n := len(nums)
    target := 0
    for i := 0; i < n; i++ {
        target = target*8 + i
...
func main() {
    ...
    fmt.Println(sortArray1([]int{2,0,1}, []int{2,3})) // 2
    fmt.Println(sortArray1([]int{1,0,2}, []int{1,3})) // -1
    fmt.Println(sortArray1([]int{0,1}, []int{2})) // 0
    fmt.Println(sortArray1([]int{0,1,2,3,4,5,6,7}, []int{1,2,3,4,5,6,7,8})) // 0
    fmt.Println(sortArray1([]int{0,1,2,3,4,5,6,7}, []int{8,7,6,5,4,3,2,1})) // 0
    fmt.Println(sortArray1([]int{7,6,5,4,3,2,1,0}, []int{1,2,3,4,5,6,7,8})) // 1
    fmt.Println(sortArray1([]int{7,6,5,4,3,2,1,0}, []int{8,7,6,5,4,3,2,1})) // 1
}