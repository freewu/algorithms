...
func main() {
    ...
    fmt.Println(bagOfTokensScore([]int{1,2,3,4,5,6,7,8,9}, 2)) // 3
    fmt.Println(bagOfTokensScore([]int{9,8,7,6,5,4,3,2,1}, 2)) // 3
    ...
    fmt.Println(bagOfTokensScore1([]int{1,2,3,4,5,6,7,8,9}, 2)) // 3
    fmt.Println(bagOfTokensScore1([]int{9,8,7,6,5,4,3,2,1}, 2)) // 3
}