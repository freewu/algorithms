...
ON
    b.book_id = r.book_id
WHERE
    b.total_copies = r.count
ORDER BY
    b.total_copies DESC, b.title ASC -- Return the result table ordered by current borrowers in descending order, then by book title in ascending order.