...
func main() {
    ...
    fmt.Printf("uniquePathsWithObstacles1([][]int{[]int{0,0,0},[]int{ 0,1,0 },[]int{0,0,0}}) = %v\n",uniquePathsWithObstacles1([][]int{[]int{0,0,0},[]int{ 0,1,0 },[]int{0,0,0}}))
    fmt.Printf("uniquePathsWithObstacles1([][]int{[]int{0,1},[]int{ 0,0 }}) = %v\n",uniquePathsWithObstacles1([][]int{[]int{0,1},[]int{ 0,0 }}))
}
